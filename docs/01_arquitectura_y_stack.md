...
El nombre del cache (`naftometro-v19.0`) se bumpeea en cada release. Combinado con cache busting en `index.html` (`?v=19.0`), esto fuerza la actualizacion de assets en produccion.
